...
public class EmailSender {
    ...
    public static void SendWelcomeEmail(String reciever) {
        String to = reciever;
        ...
        try {
            ...
            // Now set the actual message
            message.setText("Dear Member,\n\nYour Welcome to our GYM. You are one of the beasts now\n\n"
                    + "\n\n"
            ...
            // Send message
            Transport.send(message);
            System.out.println("Sent welcome message successfully....");
        } catch (MessagingException mex) {
            mex.printStackTrace();
        }
    }
